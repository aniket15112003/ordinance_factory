...
class Database {
    ...
    public function __construct($options = null) {
        try {
            ...
            /* $options = array('database_type' => 'mysql',
              'database_name' => 'taxerco_taxer',
              'server' => 'localhost',
              'username' => 'taxerco_in',
              'password' => 'Taxer@4475!@#',
              'charset' => 'utf8'); */
            if (0) {
                $options = array(
                    'database_type' => 'mysql',
                    'database_name' => 'u744520728_apnamess',
                    'server' => 'localhost',
                    'username' => 'u744520728_apnamess',
                    'password' => 'Apnamess@2023#',
                    'charset' => 'utf8'
                );
            } else {
